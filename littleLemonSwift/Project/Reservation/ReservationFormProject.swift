...
struct ReservationFormProject: View {
    ...
    //this is necessary because due to a SwiftUI limitation, we cannot change the model
    //values from within the view itself, as it is being drawn (inside the button)
    ...
    var body: some View {
        VStack {
            ...
            Form{
                ...
                HStack {
                    //containing the party title and value
                    ...
                    VStack{
                        ...
                        //the option in:Date()... alllows any date to be
                ...
                Group {
                    Group {
                        ...
                        TextField("add any special request (optional)",
                                  ...
                                  axis: .vertical ) //this keeps the text from
                        //continuing horizontally when it reaches the end
                        .padding()
            ...
            .onChange(of: mustChangeReservation) { oldValue,newValue in
    ...
    private func validateForm() {
        ...
        let temporaryReservation = Reservation(restaurant: restaurant,
                                               ...
                                               party: party,
                                               specialReqeusts: specialRequests
        )
...
#Preview {
    ...
    ReservationFormProject(sampleRestaurant).environmentObject(Model())
}
